...
public class ImageObject extends AbstractGraphicObject {
	...
	public ImageObject(ImageIcon img, Point2D pos, int id) {
		super(id);
	...
	public String objectProperties(){
		return  "[type:"+ this.getType()+"\nimage:"+this.image.getSource().toString()+"\ndimension:"+this.getDimension()+"\nfactor:"+this.factor+"\nposition:<"+ this.position.toString()+">]\n";
	}

	@Override
	public double perimeter(){
		return 2*this.getDimension().getWidth()+2*this.getDimension().getHeight();
	}
